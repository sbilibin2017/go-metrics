...
// Source: /home/sergey/Go/go-metrics/go-metrics/internal/handlers/metric_update_path.go
...
import (
	context "context"
	requests "go-metrics/internal/requests"
...
func (m *MockMetricUpdatePathUsecase) Execute(ctx context.Context, req *requests.MetricUpdatePathRequest) (*responses.MetricUpdatePathResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", ctx, req)
	ret0, _ := ret[0].(*responses.MetricUpdatePathResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
